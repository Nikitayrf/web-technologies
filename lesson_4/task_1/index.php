  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php if (count($experience) == 1 && $experience[$i]["endData"] === "Current") { ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?= $experience[$i]["name"]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]["startData"]; ?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?= $experience[$i]["description"]; ?></p>
        </div>
        <?php } elseif (count($experience) > 1 && $experience[$i]["endData"] === "Current") { ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?= $experience[$i]["name"]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]["startData"]; ?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?= $experience[$i]["description"]; ?></p>
        ...
        <?php } elseif ($i == count($experience) - 1) { ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?= $experience[$i]["name"]; ?></b></h5>
